    ...
    return (
        <div className="page">
            ...
            <div className="content-section">
                <h1 className="section-title cursor-target">Социальные сети</h1>
                <div className="socials-grid">
                    <a
                        href="https://github.com/s1lph"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="social-card cursor-target"
                    >
                        ...
                        <div className="social-info">
                            <h3 className="social-name">GitHub</h3>
                            <p className="social-username">@s1lph</p>
                        </div>
                    </a>

                    <a
                        href="https://t.me/S1LPHYE"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="social-card cursor-target"
                    >
                        ...
                        <div className="social-info">
                            ...
                            <p className="social-username">@S1LPHYE</p>
                        </div>
                    </a>
                </div>
            </div>
